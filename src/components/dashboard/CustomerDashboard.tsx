    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="container py-8 px-4 relative z-10">
        ...
        {(customer?.homeAddress || customer?.workAddress) && (
          <Card className="mb-6 shadow-soft bg-white/80 backdrop-blur-sm animate-slide-up hover-lift" style={{ animationDelay: '400ms' }}>
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
          ...
          <Card className="mb-6 shadow-elevated border-2 border-green-300/50 bg-gradient-to-br from-white to-green-50/50 animate-slide-up hover-lift backdrop-blur-sm" style={{ animationDelay: '450ms' }}>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                {!canModify && <Badge variant="destructive" className="animate-pulse"><Lock className="w-3 h-3 mr-1" />Locked</Badge>}
              </div>
            </CardHeader>
            <CardContent>
              {tomorrowMeal.isSkipped ? (
                ...
                <>
                  <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl mb-4 border border-green-100">
                    <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-green-500 to-emerald-500 flex items-center justify-center shadow-lg shadow-green-500/30">
                      <UtensilsCrossed className="w-8 h-8 text-white" />
                    </div>
                    <div className="flex-1">
                      <h3 className="font-display font-bold text-lg">{getMealName(tomorrowMeal.currentMealId)}</h3>
                      {tomorrowMeal.isSwapped && <Badge variant="secondary" className="mt-1">Swapped</Badge>}
                    </div>
                  </div>
                  {canModify && (
                    <div className="flex gap-3">
